	...
	<div class="col-md-12">
		<div class="box box-solid">
			<div class="box-header bg-gray">
				<div class="row">
					<div class="col-sm-6">
						<a href="{{ url('admin/why/create') }}" class="btn btn-primary btn-flat">
							<i class="fa fa-plus"></i>
							Tambah Why
						</a>
					</div>
					<div class="col-sm-6">
						<form id="searchForm" method="get" action="{{ url('admin/why') }}" class="input-group" style="max-width: 300px">
				...
				<table class="table table-hover table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>{!! $why->icon !!}</td>
							<td>{{ $why->title }}</td>
							<td style="max-width: 350px">{{ $why->description }}</td>
							<td>{{ $why->user->name }}</td>
							<td>
								<div class="btn-group">
									<a href="{{ url('admin/why/'.$why->id) }}" class="btn btn-info btn-xs">
										<i class="fa fa-file-text-o"></i>
									</a>
									<a href="{{ url('admin/why/'.$why->id.'/edit') }}" class="btn btn-xs btn-warning">
										<i class="fa fa-edit"></i>
									</a>
									<button class="btn btn-xs btn-danger delete-why-btn"
									url="{{ url('admin/why/'.$why->id) }}">
